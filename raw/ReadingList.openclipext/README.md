...
Save highlighted URLs directly to Safari's Reading List for offline reading.
...
1. Select any full URL in an email, document, chat, or terminal (e.g., `https://example.com/article`).
2. Click **Reading List** in the OpenClip action bar.
3. OpenClip saves the page to your Reading List and confirms with a toast notification.
