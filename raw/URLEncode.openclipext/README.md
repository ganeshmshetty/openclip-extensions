...
Percent-encode or decode query parameters, paths, and URLs.
...
1. Select text to encode, or an encoded URL/query parameter string to decode.
2. Trigger **URL Encode** in OpenClip.
3. Choose **URL Encode** or **URL Decode** to replace or copy the converted text.
